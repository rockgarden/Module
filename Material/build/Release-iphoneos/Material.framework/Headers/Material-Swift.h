...
SWIFT_CLASS("_TtC8Material24AnimatedTabBarController")
...
///
/// returns:
/// A newly initialized AnimatedTabBarController object.
...
@interface AnimatedTabBarController (SWIFT_EXTENSION(Material))
...
SWIFT_CLASS("_TtC8Material18AnimatedTabBarItem")
...
@property (nonatomic, strong) IBOutlet ItemAnimation * _Null_unspecified animation;
...
@property (nonatomic, strong) Badge * _Nullable badge;
...
@interface AnimatedTabBarItem (SWIFT_EXTENSION(Material))
/// The current badge value
...
SWIFT_CLASS("_TtC8Material5Badge")
@interface Badge : UILabel
+ (Badge * _Nonnull)badge SWIFT_WARN_UNUSED_RESULT;
...
@property (nonatomic) CGFloat cornerRadiusBounds;
...
SWIFT_CLASS("_TtC8Material13ItemAnimation")
...
SWIFT_CLASS("_TtC8Material15BounceAnimation")
...
@property (nonatomic, copy) void (^ _Nullable returnContentSize)(CGSize);
...
enum DrawerSide : NSInteger;
@class UIPanGestureRecognizer;

SWIFT_CLASS("_TtC8Material16DrawerController")
@interface DrawerController : UIViewController <UIGestureRecognizerDelegate>
@property (nonatomic, readonly) UIStatusBarStyle preferredStatusBarStyle;
@property (nonatomic, readonly) BOOL prefersStatusBarHidden;
@property (nonatomic, readonly) BOOL shouldAutorotate;
@property (nonatomic, readonly) UIInterfaceOrientationMask supportedInterfaceOrientations;
@property (nonatomic, weak) IBOutlet id <DrawerControllerDelegate> _Nullable delegate;
@property (nonatomic) float drawerWidth;
@property (nonatomic) CGFloat shadowRadius;
@property (nonatomic) float shadowOpacity;
@property (nonatomic) NSTimeInterval animationDuration;
@property (nonatomic, copy) NSString * _Nullable mainSegueIdentifier;
@property (nonatomic, copy) NSString * _Nullable leftSegueIdentifier;
@property (nonatomic, copy) NSString * _Nullable rightSegueIdentifier;
@property (nonatomic, readonly) enum DrawerSide drawerSide;
@property (nonatomic, readonly) BOOL isAnimating;
@property (nonatomic, readonly, strong) UIPanGestureRecognizer * _Nullable panGestureRecognizer;
/// Absolute
- (BOOL)getAbsoluteWithSide:(enum DrawerSide)side SWIFT_WARN_UNUSED_RESULT;
- (void)setAbsoluteWithIsAbsolute:(BOOL)isAbsolute side:(enum DrawerSide)side;
/// Bring to Front
- (BOOL)getBringToFrontWithSide:(enum DrawerSide)side SWIFT_WARN_UNUSED_RESULT;
- (void)setBringToFrontWithIsBringToFront:(BOOL)isBringToFront side:(enum DrawerSide)side;
- (void)setDrawerWidthWithDrawerWidth:(float)drawerWidth side:(enum DrawerSide)side;
/// View controller
- (void)setViewController:(UIViewController * _Nullable)viewController side:(enum DrawerSide)side;
/// Actions
- (void)openSide:(enum DrawerSide)side completion:(void (^ _Nullable)(void))completion;
- (void)closeSideWithCompletion:(void (^ _Nullable)(void))completion;
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer * _Nonnull)gestureRecognizer SWIFT_WARN_UNUSED_RESULT;
- (void)viewDidLoad;
- (void)observeValueForKeyPath:(NSString * _Nullable)keyPath ofObject:(id _Nullable)object change:(NSDictionary<NSKeyValueChangeKey, id> * _Nullable)change context:(void * _Nullable)context;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_PROTOCOL("_TtP8Material24DrawerControllerDelegate_")
@protocol DrawerControllerDelegate
@optional
- (void)drawerDidAnimationWithDrawerController:(DrawerController * _Nonnull)drawerController side:(enum DrawerSide)side percentage:(float)percentage;
- (void)drawerDidBeganAnimationWithDrawerController:(DrawerController * _Nonnull)drawerController side:(enum DrawerSide)side;
- (void)drawerWillFinishAnimationWithDrawerController:(DrawerController * _Nonnull)drawerController side:(enum DrawerSide)side;
- (void)drawerWillCancelAnimationWithDrawerController:(DrawerController * _Nonnull)drawerController side:(enum DrawerSide)side;
- (void)drawerDidFinishAnimationWithDrawerController:(DrawerController * _Nonnull)drawerController side:(enum DrawerSide)side;
- (void)drawerDidCancelAnimationWithDrawerController:(DrawerController * _Nonnull)drawerController side:(enum DrawerSide)side;
@end


SWIFT_CLASS("_TtC8Material30DrawerEmbedLeftControllerSegue")
@interface DrawerEmbedLeftControllerSegue : UIStoryboardSegue
- (void)perform;
...
SWIFT_CLASS("_TtC8Material30DrawerEmbedMainControllerSegue")
@interface DrawerEmbedMainControllerSegue : UIStoryboardSegue
- (void)perform;
- (nonnull instancetype)initWithIdentifier:(NSString * _Nullable)identifier source:(UIViewController * _Nonnull)source destination:(UIViewController * _Nonnull)destination OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC8Material31DrawerEmbedRightControllerSegue")
@interface DrawerEmbedRightControllerSegue : UIStoryboardSegue
- (void)perform;
- (nonnull instancetype)initWithIdentifier:(NSString * _Nullable)identifier source:(UIViewController * _Nonnull)source destination:(UIViewController * _Nonnull)destination OBJC_DESIGNATED_INITIALIZER;
@end

typedef SWIFT_ENUM(NSInteger, DrawerSide) {
  DrawerSideLeft = 0,
  DrawerSideRight = 1,
  DrawerSideNone = 2,
};
...
SWIFT_CLASS("_TtC8Material18FrameItemAnimation")
@interface FrameItemAnimation : ItemAnimation
...
SWIFT_CLASS("_TtC8Material13FumeAnimation")
@interface FumeAnimation : ItemAnimation
- (void)playAnimation:(UIImageView * _Nonnull)icon textLabel:(UILabel * _Nonnull)textLabel;
- (void)deselectAnimation:(UIImageView * _Nonnull)icon textLabel:(UILabel * _Nonnull)textLabel defaultTextColor:(UIColor * _Nonnull)defaultTextColor defaultIconColor:(UIColor * _Nonnull)defaultIconColor;
- (void)selectedState:(UIImageView * _Nonnull)icon textLabel:(UILabel * _Nonnull)textLabel;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC8Material17RotationAnimation")
@interface RotationAnimation : ItemAnimation
/// Start animation, method call when UITabBarItem is selected
/// \param icon animating UITabBarItem icon
///
/// \param textLabel animating UITabBarItem textLabel
...
/// Transition animtion
SWIFT_CLASS("_TtC8Material24TransitionItemAnimations")
@interface TransitionItemAnimations : ItemAnimation
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
/// Start animation, method call when UITabBarItem is selected
/// \param icon animating UITabBarItem icon
///
...
@interface UIImage (SWIFT_EXTENSION(Material))
/// resizes the image.
/// \param toWidth tw A width.
///
/// \param toHeight th A height.
///
///
/// returns:
/// An optional UIImage.
- (UIImage * _Nullable)resizeToWidth:(CGFloat)tw toHeight:(CGFloat)th SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface UIViewController (SWIFT_EXTENSION(Material))
@property (nonatomic, strong) DrawerController * _Nullable drawerController;
@property (nonatomic, readonly, strong) DrawerController * _Nullable drawerController0;
@end
